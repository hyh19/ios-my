...
Point2D controlPoint3;
Point2D controlPoint4;
Point2D endPoint;
...
- (void)initPoints {
    ...
    Point2D bezierCurvePoints[6] = {startPoint, controlPoint1, controlPoint2, controlPoint3, controlPoint4,endPoint};
...
- (void)initBezierPoints {
    ...
    controlPoint3.x = 0.25;
    controlPoint3.y = 0.1;
    
    controlPoint4.x = 0.25;
    controlPoint4.y = 1;
