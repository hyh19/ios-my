...
@implementation ZWPrizwWinnerListController
...
-(void)initConfig
{
    ...
    pullTalbeView.backgroundColor=[UIColor colorWithHexString:@"#f8f8f8"];
    ...
    [[ZWLuckPrizeNetworkManager sharedInstance] getWinnerListWithPrizeId:_prizeId wid:_wId offset:offset row:@"10" success:^(id result)
     {
         ...
         if (result)
         {
             ...
             {
                 [MobClick endEvent:@"winning_list_page_show"];//友盟统计
             }
...
-(UIView*)noWinnersView
{
    if (!_noWinnersView)
    {
        ...
        upLable.textColor=[UIColor colorWithHexString:@"#848484"];
