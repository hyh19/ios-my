#import "FBFullScreenCollectionViewController.h"

@interface FBFullScreenCollectionViewController ()

@property (nonatomic) NJKScrollFullScreen *scrollProxy;

@end

@implementation FBFullScreenCollectionViewController
...
- (BOOL)isContentHeightTooShortToLayoutUIBars {
    BOOL isContentHeightTooShortToLayoutUIBars = (self.collectionView.contentSize.height+self.collectionView.contentInset.bottom < self.collectionView.frame.size.height);
