...
- (instancetype)initWithFrame:(CGRect)frame {
    EAGLContext * eaglContext = [FBContextManager sharedInstance].eaglContext;
    if(self = [super initWithFrame:frame context:eaglContext]) {
...
- (void)updateImage:(CIImage *)image {
    ...
    [_coreImageContext drawImage:image inRect:destRect fromRect:fromRect];
