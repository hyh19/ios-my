...
- (void)applyTheme {
    ...
    if (self.theme.popupStyle == CNPPopupStyleFullscreen) {
        self.maskBackgroundColor = self.popupView.backgroundColor;
    }
    else {
        //        self.maskBackgroundColor = self.theme.maskType == CNPPopupMaskTypeClear?[UIColor clearColor] : [UIColor colorWithWhite:0.0 alpha:0.7];
    }
